...
on top of \texttt{RSQLite}\cite{JAMESRSQLite} and \texttt{RODBC}
\cite{RIPLEYRODBC}, but tries to hide 
...
with ODBC (installation not covered by this manual), and the R 
package RODBC.
...
<<echo=TRUE,eval=TRUE>>= 
system.file( "soils.accdb", package = "easydb" ) 
@ 
...
<<echo=TRUE,eval=TRUE>>= 
aDb2 <- edb( dbName = "soils.accdb", dbType = "RSQLite_SQLite", 
    accessVersion = 2007 ) 
@ 
