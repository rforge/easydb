...
"[.RSQLite_SQLite" <- function(# Extract method for reading all or part of a table in a SQLite database (referenced by 'edb').
### Extract method for reading all or part of a table in a SQLite 
...
"[<-.RSQLite_SQLite" <- function(# Assign method for SQLite databases. Write data in a SQLite table in a database (referenced by 'edb').
### Assign method for SQLite databases. Write data in a table in a 
